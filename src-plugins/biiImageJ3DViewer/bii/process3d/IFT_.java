...
System.out.println("Propagate");
	...
	public ImagePlus checkLabelfield(ImagePlus labels) {
		bii.vib.InterpolatedImage ilabels = new bii.vib.InterpolatedImage(labels);
		bii.vib.InterpolatedImage created = ilabels.cloneDimensionsOnly();
