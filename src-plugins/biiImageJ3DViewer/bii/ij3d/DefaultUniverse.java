...
import bii.ij3d.shapes.CoordinateSystem;
import bii.ij3d.shapes.Scalebar;
import bii.ij3d.behaviors.InteractiveBehavior;
...
import bii.ij3d.behaviors.BehaviorCallback;

import bii.ij3d.behaviors.Picker;
import bii.ij3d.behaviors.WaitForNextFrameBehavior;
import bii.ij3d.behaviors.ContentTransformer;
import bii.ij3d.behaviors.InteractiveViewPlatformTransformer;
...
public abstract class DefaultUniverse extends SimpleUniverse
	...
	public void show() {
		...
		win = new ImageWindow3D("Gebiss", this);
	}
