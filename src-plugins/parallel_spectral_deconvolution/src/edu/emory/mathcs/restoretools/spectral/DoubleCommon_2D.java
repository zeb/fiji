...
public class DoubleCommon_2D {
	 ...
	 */
	public static DComplexMatrix2D createFilter_2D(final DComplexMatrix2D S, final double alpha) {
	 ...
	 * @return filtered matrix
	 */
	public static DoubleMatrix2D createFilter_2D(final DoubleMatrix2D S, final double alpha) {
		final int rows = S.rows();
		final int cols = S.columns();
