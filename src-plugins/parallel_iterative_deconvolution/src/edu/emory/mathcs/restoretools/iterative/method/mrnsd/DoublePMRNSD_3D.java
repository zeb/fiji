...
public class DoublePMRNSD_3D {
	...
	/**
	 * Creates new instance of DoublePMRNSD_3D
	 * 
	 * @param imB
	 *            blurred image
	 * @param imPSF
	 ...
	 */
	public DoublePMRNSD_3D(ImagePlus imB, ImagePlus[][][] imPSF, BoundaryType boundary, ResizingType resizing, OutputType output, PreconditionerType Prec, double precTol, int maxIts, double tol, boolean xnorm, boolean showIteration) {
