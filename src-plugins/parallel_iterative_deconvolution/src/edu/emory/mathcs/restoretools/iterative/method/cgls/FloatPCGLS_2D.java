...
public class FloatPCGLS_2D {
	...
	/**
	 * Creates new instance of FloatPCGLS_2D
	 * 
	 * @param imB
	 *            blurred image
	 * @param imPSF
	 ...
	 */
	public FloatPCGLS_2D(ImagePlus imB, ImagePlus[][] imPSF, BoundaryType boundary, ResizingType resizing, OutputType output, PreconditionerType Prec, float precTol, int maxIts, float tol, boolean xnorm, boolean showIteration) {
