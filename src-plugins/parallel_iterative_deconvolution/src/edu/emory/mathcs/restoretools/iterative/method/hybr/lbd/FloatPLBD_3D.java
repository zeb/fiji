 ...
 * 
 */
public class FloatPLBD_3D implements FloatLBD_3D {
	...
	private final FloatPreconditioner_3D P;

	/**
	 * Creates new instance of FloatPLBD_3D
	 * 
	 * @param P
	 *            preconditioner
	 */
	public FloatPLBD_3D(FloatPreconditioner_3D P) {
		this.P = P;
	}

	public FloatMatrix2D[] perform(FloatPSFMatrix_3D A, FloatMatrix2D U, FloatMatrix2D B, FloatMatrix2D V, FloatHyBROptions options) {
