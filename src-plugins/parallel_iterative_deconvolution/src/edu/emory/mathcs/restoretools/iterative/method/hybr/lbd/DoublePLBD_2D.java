 ...
 * 
 */
public class DoublePLBD_2D implements DoubleLBD_2D {
	...
	private final DoublePreconditioner_2D P;

	/**
	 * Creates new instance of DoublePLBD_2D
	 * 
	 * @param P
	 *            preconditioner
	 * 
	 */
	public DoublePLBD_2D(DoublePreconditioner_2D P) {
		this.P = P;
	}
