...
public class FloatCGLS_3D {
	...
	/**
	 * Creates new instance of FloatCGLS_3D
	 * 
	 * @param imB
	 *            blurred image
	 * @param imPSF
	 ...
	 */
	public FloatCGLS_3D(ImagePlus imB, ImagePlus[][][] imPSF, BoundaryType boundary, ResizingType resizing, OutputType output, int maxIts, float tol, boolean xnorm, boolean showIteration) {
