...
public class FloatPMRNSD_3D {
	...
	/**
	 * Creates new instance of FloatPMRNSD_3D
	 * 
	 * @param imB
	 *            blurred image
	 * @param imPSF
	 ...
	 */
	public FloatPMRNSD_3D(ImagePlus imB, ImagePlus[][][] imPSF, BoundaryType boundary, ResizingType resizing, OutputType output, PreconditionerType Prec, float precTol, int maxIts, float tol, boolean xnorm, boolean showIteration) {
