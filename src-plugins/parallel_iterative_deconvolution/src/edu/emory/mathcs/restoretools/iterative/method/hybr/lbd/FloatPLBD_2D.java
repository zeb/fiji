 ...
 * 
 */
public class FloatPLBD_2D implements FloatLBD_2D {
	...
	private final FloatPreconditioner_2D P;

	/**
	 * Creates new instance of FloatPLBD_2D
	 * 
	 * @param P
	 *            preconditioner
	 * 
	 */
	public FloatPLBD_2D(FloatPreconditioner_2D P) {
		this.P = P;
	}
