...
public class DoubleCGLS_3D {
	...
	/**
	 * Creates new instance of DoubleCGLS_3D
	 * 
	 * @param imB
	 *            blurred image
	 * @param imPSF
	 ...
	 */
	public DoubleCGLS_3D(ImagePlus imB, ImagePlus[][][] imPSF, BoundaryType boundary, ResizingType resizing, OutputType output, int maxIts, double tol, boolean xnorm, boolean showIteration) {
