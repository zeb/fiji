...
jars/ij-common.jar <- modules/imagej2/
...
CLASSPATH(plugins/3D_Viewer.jar)=jars/ij.jar:jars/VIB-lib.jar:jars/imglib.jar:jars/Jama-1.0.2.jar:$JAVA3D_JARS::jars/ij-common.jar:jars/ij-plugin.jar:jars/ij-plugin-gui-swing.jar:jars/sezpoz-1.8.jar
